...
{
  protected:
    static constexpr mat2f mat2f_{ 1.0f, 2.0f, 3.0f, 4.0f };
    static constexpr mat3f mat3f_{ 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f };
    static constexpr mat4f mat4f_{ 1.0f, 2.0f,  3.0f,  4.0f,  5.0f,  6.0f,  7.0f,  8.0f,
